...
def loop():
    ...
    raw_publish = rospy.Publisher(
        'wifi_signal_raw', WifiStrength, queue_size=10)
...
def put_into_user_data_msg(nmcli_list):
    ...
    msg.rows = 1
    msg.cols = 2
    # Use OpenCV type (here 6=CV_64FC1): http://ninghang.blogspot.com/2012/11/list-of-mat-type-in-opencv.html
    msg.type = 6
